...
<body>
    ...
    <main class="container-fluid mt-3">
        ...
        <?php foreach ($result as $song) { ?>
          <div class="col-md-3">
            <div class="song-wrapped border rounded pb-3">
              <a class="d-block" href="./detail.php?ma_bviet=<?= $song['ma_bviet'] ?>">
                <img class="w-100 h-100 object-fit-cover" src="<?= $song['hinhanh'] ?>" alt="">
              </a>
