...
<?php
  if (isset($_GET['ma_bviet'])) {
    ...
    try {
      ...
      $query = "SELECT tieude,ten_bhat, ten_tloai, tomtat, noidung, ten_tgia, hinhanh
      FROM baiviet
    ...
    /* luôn là câu khởi tạo câu truy vấn -> thực thi.
    Nếu cần lấy hết để hiển thị thì dùng fetchAll rồi cho vào vòng lặp foreach
    Nếu chỉ lấy 1 thằng thì dùng fetch */
  }
  ?>
...
<body>
    ...
    <main class="container mt-5">
        <!-- <h3 class="text-center text-uppercase mb-3 text-primary">CẢM NHẬN VỀ BÀI HÁT</h3> -->
                ...
                <div class="row mb-5">
                    <div class="col-sm-4">
                        <img src="<?= $result['hinhanh'];?>" class="img-fluid" alt="...">
                    </div>
                    <div class="col-sm-8">
                        ...
                        <p class="card-text"><span class=" fw-bold">Nội dung: </span><?= $result['tomtat'];?></p>
