...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 30, 2023 lúc 04:46 AM
...
CREATE TABLE `users` (
  ...
  `chuc_vu` varchar(10) DEFAULT NULL CHECK (`chuc_vu` in ('user','admin')),
...
INSERT INTO `users` (`ma_nguoidung`, `chuc_vu`, `tai_khoan`, `mat_khau`) VALUES
(1, 'admin', 'admin123', 'admin123'),
(2, 'user', 'user123', 'user123');
